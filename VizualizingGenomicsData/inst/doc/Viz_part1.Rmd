...
if(!file.exists("ENCFF906UTB.bam")){
  download.file("https://www.encodeproject.org/files/ENCFF906UTB/@@download/ENCFF906UTB.bam",destfile = "ENCFF906UTB.bam")
}
if(!file.exists("ENCFF726OCP.bam")){
  download.file("https://www.encodeproject.org/files/ENCFF726OCP/@@download/ENCFF726OCP.bam",destfile = "ENCFF726OCP.bam")
}
```
...
```{r, cache=TRUE,message=FALSE,warning=FALSE, echo=toMessage}
options(ucscChromosomeNames=FALSE)
library(Rsamtools)
library(GenomicAlignments)
library(TxDb.Mmusculus.UCSC.mm10.knownGene)
