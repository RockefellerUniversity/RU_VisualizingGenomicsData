...
## ----all, echo=F,fig.width=18,fig.height=5,cache=T----------------------------
 
load("data/ensembl_havana_encode.RData") 


## ----b, echo=T,fig.width=18,fig.height=5,cache=T,dependson="all"--------------
plotTracks(bgrTrack) 
...
## ----a1, echo=T,eval=TRUE,fig.width=10,fig.height=5,cache=T-------------------
library(rtracklayer) 
